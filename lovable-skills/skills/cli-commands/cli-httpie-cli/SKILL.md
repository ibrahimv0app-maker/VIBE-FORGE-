---
name: cli-httpie-cli
description: Use when working with HTTPie. Always uses the correct, idiomatic commands: GET, POST, headers, auth, sessions. Not for guessing syntax — provide actual commands.
---
...
## Most-Used Commands
GET, POST, headers, auth, sessions
