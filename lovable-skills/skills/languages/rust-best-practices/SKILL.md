...
description: Use when writing Rust code. Always follows Rust idioms, style guide, type system, and best practices: ownership, borrowing, lifetimes, Result/Option, clippy clean.
---
...
- Use a formatter: ownership, borrowing, lifetimes, Result/Option, clippy clean
- Use a linter with strict rules
- Code should pass CI without warnings

## Type System (if applicable)
- Use Rust's type system to its fullest: ownership, borrowing, lifetimes, Result/Option, clippy clean
...
## Error Handling
- Follow Rust's idiom (exceptions, Result, Either, etc.)
- Handle errors at the appropriate level
- Don't swallow errors silently
- Provide context with errors

## Concurrency
- Use Rust's native concurrency primitive
...
## Testing
- Use Rust's standard test framework
- One test file per source file
- Test behavior, not implementation
- Aim for 70-80% coverage

## Common Pitfalls (specific to Rust)
