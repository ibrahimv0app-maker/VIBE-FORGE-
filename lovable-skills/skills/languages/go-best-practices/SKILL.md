...
description: Use when writing Go code. Always follows Go idioms, style guide, type system, and best practices: gofmt, interfaces, goroutines, channels, context propagation.
---
...
- Use a formatter: gofmt, interfaces, goroutines, channels, context propagation
- Use a linter with strict rules
- Code should pass CI without warnings

## Type System (if applicable)
- Use Go's type system to its fullest: gofmt, interfaces, goroutines, channels, context propagation
...
## Error Handling
- Follow Go's idiom (exceptions, Result, Either, etc.)
- Handle errors at the appropriate level
- Don't swallow errors silently
- Provide context with errors

## Concurrency
- Use Go's native concurrency primitive
...
## Testing
- Use Go's standard test framework
- One test file per source file
- Test behavior, not implementation
- Aim for 70-80% coverage

## Common Pitfalls (specific to Go)
