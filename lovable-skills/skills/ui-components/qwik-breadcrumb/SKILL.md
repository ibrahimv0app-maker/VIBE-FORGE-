---
name: qwik-breadcrumb
description: Use when building a navigation trail showing page hierarchy in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Breadcrumb Component

Build a production-grade navigation trail showing page hierarchy in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: schema.org BreadcrumbList, ellipsis for long trails
...
## Accessibility
- Correct ARIA role for the breadcrumb
