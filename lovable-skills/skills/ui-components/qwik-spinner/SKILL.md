---
name: qwik-spinner
description: Use when building a loading spinner in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Spinner Component

Build a production-grade loading spinner in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: size variants, color variants, ARIA
...
## Accessibility
- Correct ARIA role for the spinner
