---
name: preact-tabs
description: Use when building a tabbed interface in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Tabs Component

Build a production-grade tabbed interface in Preact.

## Requirements
- use Preact signals and hooks
- Features: horizontal/vertical, keyboard, dynamic tabs
...
## Accessibility
- Correct ARIA role for the tabs
