---
name: qwik-hover-card
description: Use when building a card shown on hover with delay in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Hover Card Component

Build a production-grade card shown on hover with delay in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: delay show/hide, positioned, dismissable
...
## Accessibility
- Correct ARIA role for the hover-card
