---
name: preact-chart-line
description: Use when building a line chart with time series in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Chart Line Component

Build a production-grade line chart with time series in Preact.

## Requirements
- use Preact signals and hooks
- Features: axis formatting, multi-series, hover state, legend
...
## Accessibility
- Correct ARIA role for the chart-line
