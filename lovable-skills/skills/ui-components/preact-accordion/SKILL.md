---
name: preact-accordion
description: Use when building a collapsible content panels with one or many open at a time in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Accordion Component

Build a production-grade collapsible content panels with one or many open at a time in Preact.

## Requirements
- use Preact signals and hooks
- Features: useDisclosureState, single/multi mode, keyboard arrow navigation
...
## Accessibility
- Correct ARIA role for the accordion
...
## Preact Patterns
- Use Preact idioms (not React patterns ported)
