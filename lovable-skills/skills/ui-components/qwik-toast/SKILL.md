---
name: qwik-toast
description: Use when building a transient notification in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Toast Component

Build a production-grade transient notification in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: stack, dismiss, swipe, ARIA live
...
## Accessibility
- Correct ARIA role for the toast
