---
name: qwik-date-picker
description: Use when building a date input with calendar popup in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Date Picker Component

Build a production-grade date input with calendar popup in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: single date, range, disabled dates, min/max
...
## Accessibility
- Correct ARIA role for the date-picker
