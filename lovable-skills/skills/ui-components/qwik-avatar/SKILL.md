---
name: qwik-avatar
description: Use when building a user avatar with image fallback to initials in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Avatar Component

Build a production-grade user avatar with image fallback to initials in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: image error fallback, size variants, status indicator
...
## Accessibility
- Correct ARIA role for the avatar
