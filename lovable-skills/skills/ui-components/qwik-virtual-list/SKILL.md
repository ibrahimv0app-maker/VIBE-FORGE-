---
name: qwik-virtual-list
description: Use when building a renders only visible items in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Virtual List Component

Build a production-grade renders only visible items in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: windowing, dynamic heights, scroll restoration
...
## Accessibility
- Correct ARIA role for the virtual-list
