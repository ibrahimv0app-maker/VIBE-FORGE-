---
name: qwik-slider
description: Use when building a range input with one or more thumbs in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Slider Component

Build a production-grade range input with one or more thumbs in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: min/max/step, multi-thumb, tooltips
...
## Accessibility
- Correct ARIA role for the slider
