---
name: qwik-switch
description: Use when building a toggle switch for binary state in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Switch Component

Build a production-grade toggle switch for binary state in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: on/off, disabled, label, ARIA switch
...
## Accessibility
- Correct ARIA role for the switch
