---
name: qwik-autocomplete
description: Use when building a searchable combobox with filtered suggestions in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Autocomplete Component

Build a production-grade searchable combobox with filtered suggestions in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: debounced input, async fetching, keyboard nav, ARIA combobox pattern
...
## Accessibility
- Correct ARIA role for the autocomplete
...
## Qwik Patterns
- Use Qwik idioms (not React patterns ported)
