---
name: preact-tree-view
description: Use when building a hierarchical tree in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Tree View Component

Build a production-grade hierarchical tree in Preact.

## Requirements
- use Preact signals and hooks
- Features: expand/collapse, multi-select, lazy load
...
## Accessibility
- Correct ARIA role for the tree-view
