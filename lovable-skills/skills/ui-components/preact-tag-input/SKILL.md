---
name: preact-tag-input
description: Use when building a input that creates tags in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Tag Input Component

Build a production-grade input that creates tags in Preact.

## Requirements
- use Preact signals and hooks
- Features: add/remove, autocomplete, validation
...
## Accessibility
- Correct ARIA role for the tag-input
