---
name: preact-navigation-menu
description: Use when building a mega-menu navigation in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Navigation Menu Component

Build a production-grade mega-menu navigation in Preact.

## Requirements
- use Preact signals and hooks
- Features: trigger on hover, panel with content
...
## Accessibility
- Correct ARIA role for the navigation-menu
