---
name: qwik-rating
description: Use when building a star rating input or display in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Rating Component

Build a production-grade star rating input or display in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: half stars, hover preview, keyboard
...
## Accessibility
- Correct ARIA role for the rating
