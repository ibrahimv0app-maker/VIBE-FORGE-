---
name: preact-progress
description: Use when building a linear or circular progress indicator in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Progress Component

Build a production-grade linear or circular progress indicator in Preact.

## Requirements
- use Preact signals and hooks
- Features: determinate/indeterminate, color variants
...
## Accessibility
- Correct ARIA role for the progress
