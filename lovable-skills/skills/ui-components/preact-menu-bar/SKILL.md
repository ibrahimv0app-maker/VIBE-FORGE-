---
name: preact-menu-bar
description: Use when building a horizontal application menu bar in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Menu Bar Component

Build a production-grade horizontal application menu bar in Preact.

## Requirements
- use Preact signals and hooks
- Features: File/Edit/View pattern, submenu, mnemonics
...
## Accessibility
- Correct ARIA role for the menu-bar
