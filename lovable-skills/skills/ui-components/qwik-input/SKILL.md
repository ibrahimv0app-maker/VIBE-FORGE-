---
name: qwik-input
description: Use when building a text input with variants in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Input Component

Build a production-grade text input with variants in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: size variants, icon adornments, error state
...
## Accessibility
- Correct ARIA role for the input
