---
name: qwik-combobox
description: Use when building a select with searchable input in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Combobox Component

Build a production-grade select with searchable input in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: ARIA combobox pattern, async options, multi-select
...
## Accessibility
- Correct ARIA role for the combobox
