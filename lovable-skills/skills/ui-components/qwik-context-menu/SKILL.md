---
name: qwik-context-menu
description: Use when building a right-click menu in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Context Menu Component

Build a production-grade right-click menu in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: trigger on right-click, submenus, keyboard accessible
...
## Accessibility
- Correct ARIA role for the context-menu
