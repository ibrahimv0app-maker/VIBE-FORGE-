---
name: qwik-command-palette
description: Use when building a Cmd+K command menu in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Command Palette Component

Build a production-grade Cmd+K command menu in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: fuzzy search, keyboard nav, groups, recent items
...
## Accessibility
- Correct ARIA role for the command-palette
