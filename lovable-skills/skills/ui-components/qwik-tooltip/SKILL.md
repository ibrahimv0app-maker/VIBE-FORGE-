---
name: qwik-tooltip
description: Use when building a hover/focus tooltip in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Tooltip Component

Build a production-grade hover/focus tooltip in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: delay, positioning, ARIA describedby
...
## Accessibility
- Correct ARIA role for the tooltip
