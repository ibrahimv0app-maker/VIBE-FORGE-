---
name: preact-chart-bar
description: Use when building a bar chart visualization in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Chart Bar Component

Build a production-grade bar chart visualization in Preact.

## Requirements
- use Preact signals and hooks
- Features: responsive, accessible, animated, tooltip
...
## Accessibility
- Correct ARIA role for the chart-bar
