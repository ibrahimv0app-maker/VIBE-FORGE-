---
name: preact-skeleton
description: Use when building a loading placeholder in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Skeleton Component

Build a production-grade loading placeholder in Preact.

## Requirements
- use Preact signals and hooks
- Features: shimmer animation, shapes, lines
...
## Accessibility
- Correct ARIA role for the skeleton
