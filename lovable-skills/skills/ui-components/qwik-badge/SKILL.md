---
name: qwik-badge
description: Use when building a small count or status label in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Badge Component

Build a production-grade small count or status label in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: color variants, dot variant, removable
...
## Accessibility
- Correct ARIA role for the badge
