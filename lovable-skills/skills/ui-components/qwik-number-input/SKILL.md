---
name: qwik-number-input
description: Use when building a numeric input with stepper in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Number Input Component

Build a production-grade numeric input with stepper in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: min/max, step, parse/format, locale
...
## Accessibility
- Correct ARIA role for the number-input
