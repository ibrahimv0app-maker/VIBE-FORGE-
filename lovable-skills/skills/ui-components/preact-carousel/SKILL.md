---
name: preact-carousel
description: Use when building a image/content slider with controls in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Carousel Component

Build a production-grade image/content slider with controls in Preact.

## Requirements
- use Preact signals and hooks
- Features: autoplay, loop, lazy loading, touch swipe, keyboard
...
## Accessibility
- Correct ARIA role for the carousel
