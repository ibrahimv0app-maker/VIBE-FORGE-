---
name: preact-file-upload
description: Use when building a drag-and-drop file uploader in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact File Upload Component

Build a production-grade drag-and-drop file uploader in Preact.

## Requirements
- use Preact signals and hooks
- Features: multiple files, progress, preview, validation
...
## Accessibility
- Correct ARIA role for the file-upload
