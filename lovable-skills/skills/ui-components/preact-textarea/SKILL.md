---
name: preact-textarea
description: Use when building a auto-growing textarea in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Textarea Component

Build a production-grade auto-growing textarea in Preact.

## Requirements
- use Preact signals and hooks
- Features: auto-resize, max height, character count
...
## Accessibility
- Correct ARIA role for the textarea
