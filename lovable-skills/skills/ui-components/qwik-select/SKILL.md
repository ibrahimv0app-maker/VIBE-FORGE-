---
name: qwik-select
description: Use when building a native select replacement in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Select Component

Build a production-grade native select replacement in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: searchable, multi, async, virtualized
...
## Accessibility
- Correct ARIA role for the select
