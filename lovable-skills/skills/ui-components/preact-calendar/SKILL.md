---
name: preact-calendar
description: Use when building a monthly calendar with date selection in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Calendar Component

Build a production-grade monthly calendar with date selection in Preact.

## Requirements
- use Preact signals and hooks
- Features: date range, disabled dates, min/max, i18n
...
## Accessibility
- Correct ARIA role for the calendar
