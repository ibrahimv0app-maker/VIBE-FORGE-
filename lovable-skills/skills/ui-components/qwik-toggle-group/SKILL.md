---
name: qwik-toggle-group
description: Use when building a group of toggle buttons in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Toggle Group Component

Build a production-grade group of toggle buttons in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: single/multi, size variants, icons
...
## Accessibility
- Correct ARIA role for the toggle-group
