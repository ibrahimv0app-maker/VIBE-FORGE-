---
name: qwik-drawer
description: Use when building a slide-in panel from edge in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Drawer Component

Build a production-grade slide-in panel from edge in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: left/right/top/bottom, push content or overlay
...
## Accessibility
- Correct ARIA role for the drawer
