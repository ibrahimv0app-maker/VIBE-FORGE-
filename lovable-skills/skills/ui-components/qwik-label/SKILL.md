---
name: qwik-label
description: Use when building a form label with required indicator in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Label Component

Build a production-grade form label with required indicator in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: associated with input via htmlFor
...
## Accessibility
- Correct ARIA role for the label
