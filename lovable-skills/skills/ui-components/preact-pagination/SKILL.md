---
name: preact-pagination
description: Use when building a page navigation in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Pagination Component

Build a production-grade page navigation in Preact.

## Requirements
- use Preact signals and hooks
- Features: prev/next, numbers, ellipsis, jump to page
...
## Accessibility
- Correct ARIA role for the pagination
