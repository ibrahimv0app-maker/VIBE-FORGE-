---
name: qwik-popover
description: Use when building a floating content anchored to trigger in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Popover Component

Build a production-grade floating content anchored to trigger in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: positioning, flip, shift, arrow
...
## Accessibility
- Correct ARIA role for the popover
