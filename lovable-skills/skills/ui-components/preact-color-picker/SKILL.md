---
name: preact-color-picker
description: Use when building a color selection input in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Color Picker Component

Build a production-grade color selection input in Preact.

## Requirements
- use Preact signals and hooks
- Features: HSV picker, hex input, swatches, alpha
...
## Accessibility
- Correct ARIA role for the color-picker
