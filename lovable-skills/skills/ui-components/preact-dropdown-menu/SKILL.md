---
name: preact-dropdown-menu
description: Use when building a click-triggered menu in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Dropdown Menu Component

Build a production-grade click-triggered menu in Preact.

## Requirements
- use Preact signals and hooks
- Features: submenu, dividers, icons, keyboard nav
...
## Accessibility
- Correct ARIA role for the dropdown-menu
