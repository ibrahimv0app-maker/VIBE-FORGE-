---
name: preact-menu
description: Use when building a general menu primitive in Preact. Always uses use Preact signals and hooks and follows Preact best practices for accessibility, performance, and composition.
---

# Preact Menu Component

Build a production-grade general menu primitive in Preact.

## Requirements
- use Preact signals and hooks
- Features: composable items, groups, dividers
...
## Accessibility
- Correct ARIA role for the menu
