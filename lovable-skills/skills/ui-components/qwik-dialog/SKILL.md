---
name: qwik-dialog
description: Use when building a modal dialog with backdrop in Qwik. Always uses use Qwik resumability and useSignal and follows Qwik best practices for accessibility, performance, and composition.
---

# Qwik Dialog Component

Build a production-grade modal dialog with backdrop in Qwik.

## Requirements
- use Qwik resumability and useSignal
- Features: focus trap, escape close, scroll lock, restore focus
...
## Accessibility
- Correct ARIA role for the dialog
