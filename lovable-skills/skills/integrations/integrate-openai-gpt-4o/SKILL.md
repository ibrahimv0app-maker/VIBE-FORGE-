---
name: integrate-openai-gpt-4o
description: Use when integrating OpenAI GPT-4o into an app. Always uses the official SDK, handles webhooks, errors, retries, and follows the provider's best practices. Features: multimodal, vision, audio.
---

# Integrate OpenAI GPT-4o

Production integration guide for OpenAI GPT-4o.

## What OpenAI GPT-4o Provides
multimodal, vision, audio

## Setup
1. Create account / project on OpenAI GPT-4o
2. Get API credentials (keys, tokens, OAuth client)
3. Add credentials to environment variables (never commit)
4. Install official SDK: `npm install openai_gpt_4o` (or equivalent)

## SDK Setup
```ts
// lib/openai-gpt-4o.ts
import { Client } from 'openai-gpt-4o'

export const client = new Client({
  apiKey: process.env.OPENAI_GPT_4O_API_KEY!,
})
```
