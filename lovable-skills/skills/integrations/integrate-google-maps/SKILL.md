---
name: integrate-google-maps
description: Use when integrating Google Maps Platform into an app. Always uses the official SDK, handles webhooks, errors, retries, and follows the provider's best practices. Features: maps, geocoding, places, directions.
---

# Integrate Google Maps Platform

Production integration guide for Google Maps Platform.

## What Google Maps Platform Provides
maps, geocoding, places, directions

## Setup
1. Create account / project on Google Maps Platform
2. Get API credentials (keys, tokens, OAuth client)
3. Add credentials to environment variables (never commit)
4. Install official SDK: `npm install google_maps` (or equivalent)
