---
name: integrate-lokalise-i18n
description: Use when integrating Lokalise i18n into an app. Always uses the official SDK, handles webhooks, errors, retries, and follows the provider's best practices. Features: translation management, OTA.
---

# Integrate Lokalise i18n

Production integration guide for Lokalise i18n.

## What Lokalise i18n Provides
translation management, OTA

## Setup
1. Create account / project on Lokalise i18n
2. Get API credentials (keys, tokens, OAuth client)
3. Add credentials to environment variables (never commit)
4. Install official SDK: `npm install lokalise_i18n` (or equivalent)

## SDK Setup
```ts
// lib/lokalise-i18n.ts
import { Client } from 'lokalise-i18n'

export const client = new Client({
  apiKey: process.env.LOKALISE_I18N_API_KEY!,
})
```
