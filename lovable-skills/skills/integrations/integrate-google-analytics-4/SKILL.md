---
name: integrate-google-analytics-4
description: Use when integrating Google Analytics 4 into an app. Always uses the official SDK, handles webhooks, errors, retries, and follows the provider's best practices. Features: web + app, events, audiences.
---

# Integrate Google Analytics 4

Production integration guide for Google Analytics 4.

## What Google Analytics 4 Provides
web + app, events, audiences

## Setup
1. Create account / project on Google Analytics 4
2. Get API credentials (keys, tokens, OAuth client)
3. Add credentials to environment variables (never commit)
4. Install official SDK: `npm install google_analytics_4` (or equivalent)

## SDK Setup
```ts
// lib/google-analytics-4.ts
import { Client } from 'google-analytics-4'

export const client = new Client({
  apiKey: process.env.GOOGLE_ANALYTICS_4_API_KEY!,
})
```
