---
name: integrate-auth0
description: Use when integrating Auth0 authentication into an app. Always uses the official SDK, handles webhooks, errors, retries, and follows the provider's best practices. Features: OAuth, SSO, MFA, social login.
---

# Integrate Auth0 authentication

Production integration guide for Auth0 authentication.

## What Auth0 authentication Provides
OAuth, SSO, MFA, social login

## Setup
1. Create account / project on Auth0 authentication
2. Get API credentials (keys, tokens, OAuth client)
3. Add credentials to environment variables (never commit)
4. Install official SDK: `npm install auth0` (or equivalent)
