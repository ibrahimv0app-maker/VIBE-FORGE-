---
name: integrate-crowdin-i18n
description: Use when integrating Crowdin i18n into an app. Always uses the official SDK, handles webhooks, errors, retries, and follows the provider's best practices. Features: translation management, contributors.
---

# Integrate Crowdin i18n

Production integration guide for Crowdin i18n.

## What Crowdin i18n Provides
translation management, contributors

## Setup
1. Create account / project on Crowdin i18n
2. Get API credentials (keys, tokens, OAuth client)
3. Add credentials to environment variables (never commit)
4. Install official SDK: `npm install crowdin_i18n` (or equivalent)

## SDK Setup
```ts
// lib/crowdin-i18n.ts
import { Client } from 'crowdin-i18n'

export const client = new Client({
  apiKey: process.env.CROWDIN_I18N_API_KEY!,
})
```
